...
from music.__version__ import __author__, __version__, __description__, __title__
...
intersphinx_mapping = {
    ...
    'cli_command_parser': ('https://dskrypa.github.io/cli_command_parser/', None),
}
extlinks = {
...
field_list_refs_options = {
    'skip_dirs': (docs_src.joinpath('api'),),
}
