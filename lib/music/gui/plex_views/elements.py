...
class TrackRow:
    ...
    def __init__(self, cover_size: tuple[int, int] = None, with_column: bool = True):
        ...
        self.artist = ExtText(size=(30, 1), key=f'track:{num}:artist', **kwargs)
        self.album = ExtText(size=(30, 1), key=f'track:{num}:album', **kwargs)
        self.title = Text(size=(30, 1), key=f'track:{num}:title', **kwargs)
