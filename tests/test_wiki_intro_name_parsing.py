...
016 with their first mini album ''[[Would You Like?]]''."""))
    ...
    def test_mix_with_lit(self):
        page = MagicMock(intro=as_node(""""'''Lie'''" (또 Lie; lit. "Lie Again") is the first digital single album (labeled as their fourth) by [[FAVORITE (group)|FAVORITE]]. It was released on March 11, 2020."""))
        names = set(name_from_intro(page))
